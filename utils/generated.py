    ...
    fr1.Open()
    if round(fr1.info.fps.ToFloat()) != fps:
        fr1.info.fps = fr1.info.video_timebase.Reciprocal()
        fr1.info.video_length = round(fr1.info.fps.ToFloat() * fr1.info.duration)
    ...
    fr2.Open()
    if round(fr2.info.fps.ToFloat()) != fps:
        fr2.info.fps = fr2.info.video_timebase.Reciprocal()
        fr2.info.video_length = round(fr2.info.fps.ToFloat() * fr2.info.duration)
    ...
    fr3.Open()
    if round(fr3.info.fps.ToFloat()) != fps:
        fr3.info.fps = fr3.info.video_timebase.Reciprocal()
        fr3.info.video_length = round(fr3.info.fps.ToFloat() * fr3.info.duration)
    ...
    fr4.Open()
    if round(fr4.info.fps.ToFloat()) != fps:
        fr4.info.fps = fr4.info.video_timebase.Reciprocal()
        fr4.info.video_length = round(fr4.info.fps.ToFloat() * fr4.info.duration)
    ...
    if sides_per_eye >= 5:
        ...
        fr5.Open()
        if round(fr5.info.fps.ToFloat()) != fps:
            fr5.info.fps = fr5.info.video_timebase.Reciprocal()
            fr5.info.video_length = round(fr5.info.fps.ToFloat() * fr5.info.duration)
    ...
    if sides_per_eye >= 6:
        ...
        fr6.Open()
        if round(fr6.info.fps.ToFloat()) != fps:
            fr6.info.fps = fr6.info.video_timebase.Reciprocal()
            fr6.info.video_length = round(fr6.info.fps.ToFloat() * fr6.info.duration)
    ...
    if sides_per_eye >= 7:
        ...
        fr7.Open()
        if round(fr7.info.fps.ToFloat()) != fps:
            fr7.info.fps = fr7.info.video_timebase.Reciprocal()
            fr7.info.video_length = round(fr7.info.fps.ToFloat() * fr7.info.duration)
    ...
    if sides_per_eye >= 8:
        ...
        fr8.Open()
        if round(fr8.info.fps.ToFloat()) != fps:
            fr8.info.fps = fr8.info.video_timebase.Reciprocal()
            fr8.info.video_length = round(fr8.info.fps.ToFloat() * fr8.info.duration)
